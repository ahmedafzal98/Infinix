  ...
  return (
    <body className="body">
      ...
      <main className="page__wrap">
        ...
        <section className="section track__record logo-changer">
          <div className="page-spacing__large is-track-record bg--2 radius-24">
            <div className="container-small is-track-record">
              ...
              <div className="record_grid-ingle">
                <div className="record__grid-box-single radius-24 bg--0 is-higher">
                  <h3
                    letters-slide-up=""
                    text-split=""
                    className="h2 text-3 is-track-record"
                  >
                    10K
                  </h3>
                  <div
                    className="p-body text-3 opacity-06 line-height-1 lighter margin-top-negative"
                  >
                    Businesses analyzed
                  </div>
                  <div className="record__lottie-wrapper">
                    <div
                      data-is-ix2-target="1"
                      className="record__lottie"
                      data-w-id="c35dafa5-e461-874e-449c-3f621d6a4f09"
                      data-animation-type="lottie"
                      data-src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64fecd235d5f5e68651ae0c4_Analyze.json"
                      data-loop="0"
                      data-direction="1"
                      data-autoplay="0"
                      data-renderer="svg"
                      data-default-duration="2.2022021125046733"
                      data-duration="0"
                    ></div>
                  </div>
                </div>
                <div className="record__grid-box-single radius-24 bg-accent">
                  <h3
                    letters-slide-up=""
                    text-split=""
                    className="h2 text-3 is-track-record"
                  ...
                  <div
                    className="p-body text-3 opacity-06 line-height-1 margin-top-negative"
                  >
                    Markets studied
                  </div>
                  <div className="record__lottie-wrapper is-donut">
                    <div
                      data-is-ix2-target="1"
                      className="record__lottie"
                      data-w-id="9a18cd01-fcb0-b3da-fc05-cf46d8f1dbb2"
                      data-animation-type="lottie"
                      data-src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64fed2da7f643857c638558f_DOunut.json"
                      data-loop="0"
                      data-direction="1"
                      data-autoplay="0"
                      data-renderer="svg"
              ...
              <div className="record_grid-ingle is-second">
                <div className="record__grid-box-single radius-24 bg--4 is-higher">
                  <h3
                    letters-slide-up=""
                    text-split=""
                    className="h2 is-track-record"
                  >
                    <span className="text-custom">$</span>50M+
                  </h3>
                  <div className="p-body opacity-05 lighter margin-top-negative">
                    Raised
                  </div>
                  <div className="record__lottie-wrapper">
                    <div
                      className="record__lottie opacity-05"
                      data-w-id="ddccec55-19a5-9715-6527-094e08bd40d6"
                      data-animation-type="lottie"
                      data-src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64f9cecd2c6e2f589befeecd_2%20Rized.json"
                      data-loop="0"
                      data-direction="1"
                      data-autoplay="1"
                      data-is-ix2-target="0"
                      data-renderer="svg"
                      data-default-duration="2.2022021125046733"
                      data-duration="9999999"
                    ></div>
                  </div>
                </div>
                <div className="record__grid-box-single radius-24 bg--0">
                  <h3
                    letters-slide-up=""
                    text-split=""
                    className="h2 text-3 is-track-record"
                  ...
                  <div className="record__lottie-wrapper">
                    <img
                      src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64f9d430523c74f69a8d79c2_Gear.svg"
                      loading="lazy"
                      alt=""
              ...
              <div className="record_grid-ingle">
                <div
                  className="record__grid-box-single radius-24 bg-accent top-align"
                >
                  <h3
                    letters-slide-up=""
                    text-split=""
                  ...
                  <div className="record__lottie-wrapper is-clients">
                    <div className="client__inner-wrap">
                      <div className="clientbody"></div>
                      <div className="client__head-wrapper">
                        <div className="client-head"></div>
                        <div className="client-head oposite"></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="record__grid-box-single radius-24 bg--4">
                  <h3
                    letters-slide-up=""
                    text-split=""
                    className="h2 text-accent is-track-record"
                  >
                    4.9/5
                  </h3>
                  <div
                    className="p-body lighter opacity-05 margin-top-negative text-balance"
                  >
                    Average customer rating
                  </div>
                  <div className="record__lottie-wrapper is-small-paddig">
                    <div
                      className="record__lottie opacity-05"
                      data-w-id="8ebee638-2da0-14ee-10af-8afa8249611b"
                      data-animation-type="lottie"
                      data-src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64fecdbf4af28a2a7cd62c84_StarAnim.json"
                      data-loop="0"
                      data-direction="1"
                      data-autoplay="1"
                      data-is-ix2-target="0"
        ...
        {/* <!-- <section id="why-us" className="section is-service is-accordion">
        <div className="page-spacing__medium z-index is-logos">
          <div className="container-small">
            <div className="section__home-about">
              <div className="spacing-container-02 hide-on-mobile"></div>
              <div className="home__about-wrapper-inner">
                <div className="column-50 flex-vertical">
                  <div
                    className="p-body text-2 text-lighter sticky-heading opacity-07 mobile-h2"
                  >
                    Why us?
                  </div>
                </div>
                <div className="column-50 flex-vertical">
                  <div className="whyus__collection w-dyn-list">
                    <div role="list" className="whyus__list w-dyn-items">
                      <div role="listitem" className="w-dyn-item">
                        <div
                          data-w-id="9b88e4c1-9bcc-24f9-66cd-c03e1ff6ddf8"
                          className="whyus__single"
                        >
                          <div
                            className="separator ap-top-copy bg-accent opacity-01"
                          ></div>
                          <a
                            stagger-link=""
                            href="#"
                            className="whyus_heading-wrapper w-inline-block"
                            ><h1
                              className="h3 whyus__heading-single line-height-1 is-accordion"
                            >
                              Results Driven
                            </h1></a
                          >
                          <div style="height: 0px" className="whyus__accordion">
                            <div
                              className="p-body-normal opacity-03 letter-spacing-0-5 is-bigger opacity-04"
                            >
                              Delivering actionable insights with measurable RoI
                            </div>
                          </div>
                          <div
                            style="
                            ...
                            "
                            className="whyus__expand"
                          >
                            <div
                              style="background-color: rgb(151, 210, 139)"
                              className="whyus__vertical bg-accent"
                            ></div>
                            <div
                              style="background-color: rgb(151, 210, 139)"
                              className="whyus__horizontal is-horizontal bg-accent"
                            ></div>
                          </div>
                        </div>
                      </div>
                        ...
                        >
                          ...
                          <div style="height: 0px" className="whyus__accordion">
                            <div
                              className="p-body-normal opacity-03 letter-spacing-0-5 is-bigger opacity-04"
                            >
                              Get 80% of the value of traditional research and
                              analysis for 20% of the cost
                            </div>
                          </div>
                          <div
                            style="
                        ...
                        >
                          ...
                          <div style="height: 0px" className="whyus__accordion">
                            <div
                              className="p-body-normal opacity-03 letter-spacing-0-5 is-bigger opacity-04"
                            >
                              Methodologies inspired by human creativity and
                        ...
                        >
                          ...
                          <div style="height: 0px" className="whyus__accordion">
                            <div
                              className="p-body-normal opacity-03 letter-spacing-0-5 is-bigger opacity-04"
                            >
                              Hundreds of completed projects across all sectors
                              and verticals
                            </div>
                          </div>
                          <div
        ...
        <div
          data-w-id="056fcf80-4f73-5d00-3129-a787fbb42670"
          className="gradient__image-wrapper"
        >
          <img
            ...
            loading="lazy"
            alt=""
            className="gradient__image is-5 opacity-07 change-opa"
          />
        </div>
      </section> --> */}
        ...
        <section className="section is-full logo-changer is-logos">
          ...
          >
            ...
            <div className="p-body opacity-08 lighter line-height-1">Load more</div>
          </div> --> */}
          </div>
        </section>
        {/* <!-- <section className="section is-testimonials">
        <div className="page-spacing__medium z-index-5 is-testimonials">
          <div className="container-small">
            <div className="section__home-about">
              <div className="spacing-container-02"></div>
              <div className="home__testimonials-wrapper-inner">
                <div
                  className="column-50 flex-vertical is-centered is-testimonials"
                >
                  <h2
                    letters-slide-up=""
                    text-split=""
                    className="testimonialheading line-height-09"
                  >
                    Hear it from our clients
                  </h2>
                  <div className="spacing-bottom-02"></div>
                  <div className="testimonials__switcher radius-full">
                    <div
                      data-w-id="a828b800-d354-f010-3e42-a12b5fc8274f"
                      className="testimonial__swittcher-button is-fiver"
                    >
                      <div className="p-body-normal text-3 is-fiver">Fiverr</div>
                    </div>
                    <div
                      data-w-id="52724a3f-3ec5-5cce-2e1c-889a6d09c049"
                      className="testimonial__swittcher-button is-upwork"
                    >
                      <div className="p-body-normal opacity-05-not is-upwork">
                        Upwork
                      </div>
                    </div>
                    <div className="testimonials__switcher-activeel is-home"></div>
                  </div>
                </div>
                <div
                  className="column-50 flex-vertical is-testimonial is-testimonials"
                >
                  <div className="testimonial__slider-wrapper-fiver">
                    <div className="swiper fiverr w-dyn-list">
                      <div role="list" className="swiper-wrapper w-dyn-items">
                        <div
                          role="listitem"
                          className="swiper-slide is-content w-dyn-item"
                        >
                          <div className="testimonial__single-item radius-24">
                            <div className="testimonial-link-wrapper">
                              <div className="testimonial__item-count">
                                <div
                                  className="testimonial__item-count-bg radius-full opacity-07"
                                ></div>
                                <div className="p-small text-3 z-index-5">
                                  151 of 324
                                </div>
                              </div>
                              <a
                                href="https://www.fiverr.com/dikovh"
                                target="_blank"
                                className="testimonial__item-count is-link w-inline-block"
                                ><div
                                  className="p-small text-3 z-index-5 line-height-1 no-events is-testim"
                                >
                                  Read more
                                </div>
                                <div
                                  className="testimonial__item-count-bg-outline radius-full"
                                ></div
                              ></a>
                            </div>
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              Working with Addifico was a pleasure. Despite
                              needing market research and competitor analysis in
                              a niche area, they delivered beyond my
                              expectations. All of the work was comprehensive,
                              well-structured and extremely detailed. The
                              communication was perfect and they operated with
                              great professionalism.
                            </div>
                            <img
                              src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64ec45d3256eff900454a0a2_Quotes-icon-New.svg"
                              loading="lazy"
                              alt=""
                              className="testimonial__single-quote-image"
                            />
                            <div className="testimonial__author-wrap">
                              <div
                                className="separator ap-top bg--3 opacity-01"
                              ></div>
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501efb9825d3f9226e9ed13_Ben%20Cane.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                                <h3
                                  className="text-3 p-body is-bold letter-spacing-0-5"
                                >
                                  Ben Cane
                                </h3>
                                <div className="subtitle text-3 opacity-05">
                                  Founder of Munity
                                </div>
                              </div>
                            </div>
                        ...
                        >
                          <div className="testimonial__single-item radius-24">
                            ...
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              This is my second time working with Addifico
                              Consulting on a market research project. They are
                              prompt, professional, and provide top-notch
                              deliverables. They are always quick to respond
                              with clarification if needed, and overall, they’ve
                              been a pleasure to work with. I&#x27;d heartily
                              recommend them for anyone looking for professional
                              market research.
                            </div>
                            <img
                              src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64ec45d3256eff900454a0a2_Quotes-icon-New.svg"
                            ...
                            <div className="testimonial__author-wrap">
                              ...
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501ef96e58b2a3830418781_Will%20Evertsen.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                        ...
                        >
                          <div className="testimonial__single-item radius-24">
                            ...
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              Addifico was phenomenal and worked quickly to help
                              me get the information I needed. In addition to
                              purchasing one of the programs/plans they had,
                              they helped me figure out what I needed best. They
                              were able to also help me break down the data and
                              provided some additional feedback on my pitch
                              deck. I look forward to working with them further
                              as I expand on my project. Highly recommend.
                            </div>
                            <img
                              src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64ec45d3256eff900454a0a2_Quotes-icon-New.svg"
                              loading="lazy"
                            ...
                            <div className="testimonial__author-wrap">
                              ...
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501ef758024fac2a534c086_Deshawn%20Robinson.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                        ...
                        >
                          <div className="testimonial__single-item radius-24">
                            ...
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              Phenomenal job. We are a very niche market and I’m
                              sure it took some extra digging to find all the
                              information for the market research report. The
                              report is incredibly detailed, accurate and well
                              written. Very very happy with the work!
                            </div>
                            <img
                              src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64ec45d3256eff900454a0a2_Quotes-icon-New.svg"
                              loading="lazy"
                            ...
                            <div className="testimonial__author-wrap">
                              ...
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501ef40684acb3475f6aae5_Nelson%20Dunk.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                                ...
                                <div className="subtitle text-3 opacity-05">
                                  Chief Creative Office at Skylight Visual Media
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        >
                          <div className="testimonial__single-item radius-24">
                            ...
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              The analysis was very profound, even though the
                              business model is rather new and experimental.
                              Every result and figure was marked with the source
                              and every calculation can be reconsidered
                            </div>
                            <img
                              src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64ec45d3256eff900454a0a2_Quotes-icon-New.svg"
                              loading="lazy"
                            ...
                            <div className="testimonial__author-wrap">
                              ...
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501ef2045a8dcfd1d431f9b_Oliver%20Lauche.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                    ...
                    <div className="slider-main_button-wrapper">
                      <a
                        href="#"
                        className="slider-main_button swiper-prev is-disabled w-inline-block"
                        ><div
                          data-w-id="375e1af4-b5a1-12d5-aa6a-0137bd509bb2"
                          className="animated-arrow-wrapper is--rotated"
                        >
                          <div className="arrow-animated-button">
                            <div className="arrow__arrows-wrapper">
                              <img
                                src="https://assets-global.website-files.com/63793925c7db23ce040b0824/65017f53133e2c6dc9b9266a_Slider-arrow.svg"
                                loading="lazy"
                                alt=""
                                className="arrow-image opacity-06"
                              /><img
                                src="https://assets-global.website-files.com/63793925c7db23ce040b0824/65017f53133e2c6dc9b9266a_Slider-arrow.svg"
                                loading="lazy"
                                alt=""
                                className="arrow-image-absolute opacity-06"
                              />
                            </div>
                            <div className="arrow__circle"></div>
                            <div
                              style="
                                ...
                                transform: translate3d(-110%, 0, 0)
                                  ...
                                  rotateZ(0) skew(0, 0);
                              "
                              className="arrow__circle-absolute"
                            ></div>
                          </div></div></a
                      ><a
                        href="#"
                        ...
                        ><div
                          data-w-id="375e1af4-b5a1-12d5-aa6a-0137bd509bba"
                          className="animated-arrow-wrapper"
                        >
                          <div className="arrow-animated-button">
                            <div className="arrow__arrows-wrapper">
                              <img
                  ...
                  <div
                    style="
                      -webkit-transform: translate3d(3em, 1.6em, 0)
                        scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(5deg)
                        skew(0, 0);
                      -moz-transform: translate3d(3em, 1.6em, 0)
                        scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(5deg)
                        skew(0, 0);
                      -ms-transform: translate3d(3em, 1.6em, 0) scale3d(1, 1, 1)
                        rotateX(0) rotateY(0) rotateZ(5deg) skew(0, 0);
                      transform: translate3d(3em, 1.6em, 0) scale3d(1, 1, 1)
                        rotateX(0) rotateY(0) rotateZ(5deg) skew(0, 0);
                      opacity: 0;
                    "
                    className="testimonial__slider-wrapper-upwork"
                  >
                    <div className="swiper upwork w-dyn-list">
                      <div role="list" className="swiper-wrapper w-dyn-items">
                        <div
                          role="listitem"
                          className="swiper-slide is-content w-dyn-item"
                        >
                          <div className="testimonial__single-item radius-24">
                            <a
                              href="https://www.upwork.com/freelancers/hristodikov/"
                              className="testimonial__item-count is-link hide-on-desktop w-inline-block"
                              ><div
                                className="p-small text-3 z-index-5 line-height-1 no-events is-testim"
                              >
                                Read more
                            ...
                            <div className="testimonial-link-wrapper">
                              ...
                              <a
                                href="https://www.upwork.com/freelancers/hristodikov/"
                                target="_blank"
                                className="testimonial__item-count w-inline-block"
                                ><div
                                  className="p-small text-3 z-index-5 line-height-1 no-events"
                                >
                                  Read more
                                </div>
                                <div
                            ...
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              Addifico Consulting conducted market research to
                              help us evaluate a potential market entry
                              opportunity for an eCommerce marketplace in a
                              European market targeted to a specific consumer
                              demographic. Their research was solid and the team
                              was very professional and easy to communicate with
                              and work with.
                            </div>
                            <img
                              src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64ec45d3256eff900454a0a2_Quotes-icon-New.svg"
                            ...
                            <div className="testimonial__author-wrap">
                              ...
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501f2440e3f30b95abb4f68_Kristen%20Proctor.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                                ...
                                <div className="subtitle text-3 opacity-05">
                                  Head of Strategic Growth at Autofulfil Limited
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        >
                          <div className="testimonial__single-item radius-24">
                            ...
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              Addifico Consulting did an excellent job
                              researching, writing, and editing ebooks and
                              market insight reports for us. They welcomed all
                              feedback and adjusted it accordingly in the
                              documents. I highly recommend Addifico Consulting
                              for their excellent research skills and we will
                            ...
                            <div className="testimonial__author-wrap">
                              ...
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501f25d13aaaf46d0806436_Mohamed%20Ahmed.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                                ...
                                <div className="subtitle text-3 opacity-05">
                                  xCEO at Magalix (acquired by Weaveworks)
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        >
                          <div className="testimonial__single-item radius-24">
                            ...
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              Addifico’s team are masters at their work. They
                              helped us with research, CI, data analysis and
                              many tasks which took them 1/10 of the time they
                              would take us. In all cases, their work was
                              professional. I strongly recommend anyone looking
                              for a high-quality research and analysis to hire
                              Addifico Consulting.
                            </div>
                            <img
                              src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64ec45d3256eff900454a0a2_Quotes-icon-New.svg"
                            ...
                            <div className="testimonial__author-wrap">
                              ...
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501f2948cb0cb32620b3348_Bar%20Winkler.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                                ...
                                <div className="subtitle text-3 opacity-05">
                                  Ex Senior Director BD at IronSource
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        >
                          <div className="testimonial__single-item radius-24">
                            ...
                            <div
                              className="p-body-normal text-3 line-height-1-5 z-index-5 is-testimonial opacity-08"
                            >
                              Addifico did an amazing job in a quick
                              turn-around. They go straight to the point and
                              provide great reasoning and the thought process
                              for any deliverable! I would highly recommend
                              them!
                            </div>
                            <img
                              src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64ec45d3256eff900454a0a2_Quotes-icon-New.svg"
                            ...
                            <div className="testimonial__author-wrap">
                              ...
                              <div
                                style="
                                  background-image: url('https://assets-global.website-files.com/64e8bbf4a8e46c39e0352f6e/6501f2b314a166748bf0aa25_Laurent%20Goffinon.jpg');
                                "
                                className="testimonial__author-photo"
                              ></div>
                              <div className="testimonial__author-name">
                    ...
                    <div className="slider-main_button-wrapper">
                      <a
                        href="#"
                        className="slider-main_button upwork-prev w-inline-block"
                        ><div
                          data-w-id="19a545b3-a58c-b207-ece8-9c331133789e"
                          className="animated-arrow-wrapper is--rotated"
                        >
                          <div className="arrow-animated-button">
                            <div className="arrow__arrows-wrapper">
                      ...
                      ><a
                        href="#"
                        className="slider-main_button upwork-next w-inline-block"
                        ><div
                          data-w-id="19a545b3-a58c-b207-ece8-9c33113378a6"
                          className="animated-arrow-wrapper"
                        >
                          <div className="arrow-animated-button">
                            <div className="arrow__arrows-wrapper">
        ...
        <div className="gradient__image-wrapper">
          <img
            src="images/background.jpg"
            loading="lazy"
            sizes="100vw"
            srcset="
              /images/background-500.jpg   500w,
              /images/background-800.jpg   800w,
              /images/background-1080.jpg 1080w,
              /images/background.jpg      1604w
            "
            alt=""
            className="gradient__image is-5 opacity-05"
          />
        </div>
      </section> --> */}
      ...
      <div className="globals">
            ...
            ><div className="nav__logo w-embed">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M104.633 4.13428H111.165L115.297 0H108.77L104.633 4.13428ZM98.6719 8.34644H92.1396L96.2764 4.20728H102.804L98.6719 8.34644ZM99.3818 9.15967V15.6946L103.515 11.5554V5.02539L99.3818 9.15967ZM111.866 4.95264V11.4827L115.999 7.34839V0.818359L111.866 4.95264ZM100.28 16.7612H106.812L110.945 12.627H104.418L100.28 16.7612ZM107.518 17.5793V24.1094L111.649 19.9751V13.4451L107.518 17.5793ZM71.6475 18.4016C72.1289 17.9731 72.3721 17.384 72.3721 16.634C72.3721 15.8843 72.1289 15.2949 71.6475 14.8665C71.165 14.438 70.5957 14.2236 69.9385 14.2236C69.2812 14.2236 68.7119 14.438 68.2305 14.8665C67.748 15.2998 67.5049 15.8843 67.5049 16.634C67.5049 17.384 67.748 17.9731 68.2305 18.4016C68.7119 18.8303 69.2812 19.0444 69.9385 19.0444C70.5957 19.0444 71.165 18.8303 71.6475 18.4016Z"
                  file="white"
                />
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M44.8447 21.012V14.6038L48.9238 13.9512V34.7249C48.835 34.7517 48.7441 34.7783 48.6504 34.8044C48.541 34.8347 48.4287 34.8645 48.3125 34.8938C48.1094 34.9448 47.8936 34.9941 47.6631 35.0413C47.1855 35.1387 46.6895 35.2263 46.1689 35.2993C45.6523 35.3726 45.1172 35.4358 44.582 35.4795L44.4512 35.4912C43.6895 35.5605 41.0977 35.7969 38.9746 35.0266C38.0938 34.7053 37.3643 34.1453 36.7461 33.4783C36.1279 32.811 35.6406 32.0076 35.2949 31.0679C34.9502 30.1279 34.7744 29.0906 34.7744 27.9609C34.7744 26.8311 34.9541 25.8037 35.3096 24.8687C35.665 23.9387 36.1562 23.1448 36.7842 22.4875C37.4121 21.8301 38.1621 21.3188 39.0283 20.9536C39.8945 20.5884 40.8242 20.4082 41.8613 20.4082C42.0859 20.4082 42.3066 20.4167 42.5225 20.4336C42.877 20.4612 43.2217 20.5117 43.5557 20.5852C43.959 
101.21 33.4834C101.828 32.8162 102.305 32.0127 102.631 31.0728ZM98.2168 24.9956C98.7178 25.7163 98.9707 26.7048 98.9707 27.9661C98.9707 29.2273 98.7178 30.2256 98.2168 30.9658C97.7148 31.7058 97 32.0759 96.0703 32.0759C95.1406 32.0759 94.4199 31.7058 93.9092 30.9658C93.6885 30.6465 93.5156 30.2791 93.3906 29.863C93.2852 29.5103 93.2139 29.1226 93.1758 28.7C93.1553 28.4661 93.1445 28.2214 93.1445 27.9661C93.1445 26.7048 93.3975 25.7163 93.9092 24.9956C94.4199 24.2749 95.1406 23.9146 96.0703 23.9146C97 23.9146 97.7148 24.2749 98.2168 24.9956ZM83.6387 30.5432C83.5654 30.6921 83.4844 30.8328 83.3945 30.9653C82.8926 31.7053 82.1777 32.0754 81.248 32.0754C80.3184 32.0754 79.5977 31.7053 79.0869 30.9653C78.8037 30.5547 78.5996 30.0649 78.4736 29.4949C78.373 29.0369 78.3223 28.5273 78.3223 27.9656C78.3223 27.4597 78.3633 26.9978 78.4453 26.5793C78.5674 25.9546 78.7812 25.4268 79.0869 24.9951C79.5977 24.2744 80.3184 23.9141 81.248 23.9141C82.1777 23.9141 82.8926 24.2744 83.3945 24.9951C83.6035 25.2971 83.7695 25.6477 83.8906 26.0471C84.5576 25.7549 85.2344 25.4919 85.9209 25.2385C86.3965 25.0637 86.8652 24.8413 87.3379 24.6167L87.6191 24.4839C87.2881 23.7241 86.8643 23.0571 86.3389 22.4971C85.7207 21.8396 84.9766 21.3284 84.1094 20.9631C83.2432 20.5979 82.2891 20.4177 81.2529 20.4177C80.2158 20.4177 79.2861 20.6028 78.4199 20.9631C77.5537 21.3284 76.8037 21.8396 76.1758 22.4971C75.5488 23.1545 75.0566 23.9482 74.6963 24.8784C74.3408 25.8083 74.1611 26.8408 74.1611 27.9705C74.1611 29.1003 74.3359 30.1375 74.6816 31.0771C75.0273 32.0171 75.5098 32.8206 76.1328 33.4878C76.751 34.1548 77.4951 34.6711 78.3613 35.0361C79.2275 35.4014 80.1914 35.5815 81.248 35.5815C82.3037 35.5815 83.2969 35.3967 84.1631 35.0361C85.0293 34.6711 85.7744 34.1548 86.3926 33.4878C86.6143 33.2517 86.8154 32.9971 86.998 32.7246C87.3008 32.272 87.5527 31.7705 87.7559 31.2234C86.7383 30.9773 85.7393 30.6052 84.7441 30.2344C84.458 30.1279 84.1719 30.0215 83.8857 29.9133C83.8174 30.1375 83.7354 30.3474 83.6387 30.5432Z"
                  fill="currentColor"
                />
              </svg></div></a>
          <div className="nav__logo-cta-wrapper">
        ...
        <div className="hidden-navigation">
          <div className="nav__wrapper">
            <div className="nav_top-wrapper">
              ...
              >
              <div className="nav_top-single">
                <div className="p-body nav__top-text letter-spacing-0-5">menu</div>
              </div>
            </div>
            <div className="separator-footer bg--1 opacity-01"></div>
            <div className="nav_main-wrapper">
        ...
        {/* <!-- <div className="loader-logo">
        <img
          src="https://assets-global.website-files.com/63793925c7db23ce040b0824/64f472fc055ab00edff856e8_Logo-Animation.gif"
          loading="eager"
          alt=""
          className="loader-image"
        />
